export const USAGE = `
    usage: ts-unused-exports path/to/tsconfig.json [file1.ts file2.ts] [--excludeDeclarationFiles][--exitWithCount][--disableSearchNamespaces][--ignorePaths=path1;path2][--showLineNumber]
